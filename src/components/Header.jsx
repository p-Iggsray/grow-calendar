  ...
  return (
    <div style={{
      ...
      <div style={{ marginBottom: 11 }}>
        <div style={{ fontSize: 10, letterSpacing: 4, color: "#5a8a5a", textTransform: "uppercase", marginBottom: 4, fontFamily: "'Courier New', monospace" }}>
          Grow Log · {LOCATION}
        </div>
        <div style={{ fontSize: 22, fontWeight: 900, letterSpacing: -1, lineHeight: 1.1, color: "#e8f5e3" }}>
          The Grow Calendar
        </div>
