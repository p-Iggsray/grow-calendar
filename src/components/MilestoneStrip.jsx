        ...
        {milestones.map(m => {
          ...
          return (
            <div
              ...
              <div style={{ fontSize: 11, fontFamily: "'Courier New', monospace", color: isToday ? m.color : "var(--c-text-ghost)", marginTop: 4, whiteSpace: "nowrap" }}>
                {fmt(m.date)}
              </div>
              <div style={{ fontSize: 11, color: "var(--c-text-faint)", marginTop: 2, fontFamily: "'Courier New', monospace", whiteSpace: "nowrap" }}>
                {m.label}
              </div>
            </div>
          );
