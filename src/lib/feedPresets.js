...
export const PRESETS = [
  {
    ...
    description: "The classic liquid trio schedule. Soil-friendly and widely available.",
    tasks: {
      veg_cm: [
        ...
        "GROWTH OBSERVATION: Look for new nodes every few days — steady new growth confirms healthy establishment.",
        "PEST CHECK: Inspect the underside of every leaf on every plant. Catching problems early saves plants.",
      ],
      veg_half: [
      ...
      veg_full: [
        "MOISTURE CHECK: Lift or finger-test. Hot weather means fabric pots can need water every 24 hours.",
        ...
        "IF MOVING OUTDOORS: Water all pots 2–3 hours before moving. Scout the sunniest spot (8+ hours direct sun). Move one pot at a time — they are heavy.",
      ...
      pre_flower: [
        ...
        "STAKE CHECK: Plants can stretch fast heading into flower. Tie any leaning branches loosely to stakes now before they get heavier.",
      ],
      flower: [
        ...
        "TRICHOME CHECK: From week 6 of flower, use a phone macro or loupe weekly. Harvest when trichomes are mostly cloudy with some amber starting.",
  ...
  },
  {
    ...
    tasks: {
      ...
      veg_full: [
        "MOISTURE CHECK: Hot weather means daily watering.",
        ...
        "IF MOVING OUTDOORS: Water 2–3 hours before moving. Aim for 8+ hours direct sun daily.",
        "PEST CHECK: Underside of all leaves daily.",
      ],
      pre_flower: [
        ...
        "STAKE CHECK: Stretch begins soon — tie branches loosely before they get heavy.",
      ],
      flower: [
        ...
        "TRICHOME CHECK: From week 6, use a loupe or phone macro weekly. Harvest when mostly cloudy with some amber.",
      ],
    },
  },
  {
    ...
    tasks: {
      ...
      veg_full: [
        "MOISTURE CHECK: Hot weather means checking every morning. Fabric pots can dry out in 24 hours.",
        ...
        "IF MOVING OUTDOORS: Water 2–3 hours before moving. Scout 8+ hours of direct sun.",
      ...
      pre_flower: [
        ...
        "PISTIL WATCH: White hairs at the nodes signal the flip to flower.",
        "STAKE CHECK: Stretch is coming — tie branches loosely before they get heavy.",
      ],
      flower: [
        ...
        "TRICHOME CHECK: From week 6, use a loupe or phone macro weekly. Harvest when trichomes are mostly cloudy with some amber.",
      ],
    },
  },
];
